...
<html lang="en"> 
    ...
    <body>
		...
		<center>
		<p> PLEASE ENTER YOUR USERNAME, PASSWORD <BR>
		AND YOUR NEW PASSWORD TO UPDATE<br>
		YOUR PASSWORD.</p>
		</center>
				...
				if($FailedLogins < 3){
					...
					if ($r) {
						...
						if (password_verify($password,$pp)){
							...
							$sql2 = "UPDATE customer_accounts SET hashed_password='$new_hashed_password' WHERE username='$username'";
